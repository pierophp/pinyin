...
const handler: Handler = async (event, context) => {
  ...
  //   dictPath:
  //     '/home/piero/dev/pinyin/services/jieba/node_modules/separate-chinese-words/dict/jieba.dict.utf8',
  //   userDictPath:
  //     '/home/piero/dev/pinyin/services/jieba/node_modules/separate-chinese-words/dict/user.dict.utf8',
  // }).filter((item) => {
  //   return item
